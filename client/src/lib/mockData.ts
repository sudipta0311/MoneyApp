...
export const MOCK_TRANSACTIONS: Transaction[] = [
  {
    ...
    explanation: {
      summary: 'You paid Starbucks via UPI.',
      amount: 450.00,
      currency: '₹',
      type: 'debit',
      merchant: 'Starbucks',
  ...
  },
  {
    ...
    explanation: {
      summary: 'Your salary was credited to your account.',
      amount: 25000.00,
      currency: '₹',
      type: 'credit',
  ...
  },
  {
    ...
    explanation: {
      summary: 'Netflix subscription payment via Credit Card.',
      amount: 12.99,
      currency: '$',
      type: 'debit',
      merchant: 'Netflix',
  ...
  },
  {
    ...
    explanation: {
      summary: 'OTP for a pending Amazon purchase.',
      amount: 1200.00,
      currency: '₹',
      type: 'alert',
      merchant: 'Amazon',
